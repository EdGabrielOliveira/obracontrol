...
CREATE TABLE "ConstructionBudgetItem" (
    ...
    "laborUnitCost" DECIMAL(65,30),
    "materialUnitCost" DECIMAL(65,30),
    "equipmentUnitCost" DECIMAL(65,30),
    "otherUnitCost" DECIMAL(65,30),
    "unitCostTotal" DECIMAL(65,30),
    ...
    "completionPercentage" DECIMAL(65,30) NOT NULL DEFAULT 0,
    "providedStatus" TEXT,
...
CREATE TABLE "BudgetVersion" (
    ...
    "budgetImportId" TEXT,
    "kind" TEXT,
    "acrescimoBruto" DECIMAL(65,30),
    "supressao" DECIMAL(65,30),
    "impactoLiquido" DECIMAL(65,30),
    "percentualImpacto" DECIMAL(65,30),
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "BudgetItemIdentity" (
    ...
    CONSTRAINT "BudgetItemIdentity_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "BudgetVersionItem" (
    ...
    CONSTRAINT "BudgetVersionItem_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "ConstructionBudgetReconciliation" (
    ...
    CONSTRAINT "ConstructionBudgetReconciliation_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "BudgetProjectionState" (
    ...
    CONSTRAINT "BudgetProjectionState_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "BudgetProjectionOutbox" (
    ...
    CONSTRAINT "BudgetProjectionOutbox_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "Contract" (
    ...
    "penaltyPercent" DECIMAL(65,30) NOT NULL DEFAULT 20,
    ...
    "instrumentGeneratedAt" TIMESTAMP(3),
...
CREATE TABLE "ContractInstrumentArtifact" (
    ...
    CONSTRAINT "ContractInstrumentArtifact_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "ContractMeasurement" (
    ...
    "retentionValue" DECIMAL(65,30),
    "taxValue" DECIMAL(65,30),
...
CREATE TABLE "ContractMeasurementItem" (
    ...
    "measuredQuantity" DECIMAL(65,30),
    "measuredValue" DECIMAL(65,30),
    "measuredPercentage" DECIMAL(65,30),
    "accumulatedQuantity" DECIMAL(65,30),
    "accumulatedValue" DECIMAL(65,30),
    "accumulatedPercentage" DECIMAL(65,30),
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "ContractMeasurementItem_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "ConstructionContractAmendment" (
    ...
    "gestorReviewedAt" TIMESTAMP(3),
    "gerenteReviewedBy" TEXT,
    "gerenteReviewedAt" TIMESTAMP(3),
    "effectiveAt" TIMESTAMP(3),
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "ConstructionContractAmendment_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "ContractAmendmentMeasurement" (
    ...
    CONSTRAINT "ContractAmendmentMeasurement_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "ConstructionMeasurement" (
    ...
    "measuredPercentageAccumulated" DECIMAL(65,30),
    "measuredQuantityAccumulated" DECIMAL(65,30),
    "measuredValue" DECIMAL(65,30),
    "status" TEXT NOT NULL DEFAULT 'RASCUNHO',
    "notes" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "ConstructionActualCost" (
    ...
    CONSTRAINT "ConstructionActualCost_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "CostMigrationLineage" (
    ...
    CONSTRAINT "CostMigrationLineage_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "ActualCostAllocation" (
    ...
    CONSTRAINT "ActualCostAllocation_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "WorkMeasurementItem" (
    ...
    CONSTRAINT "WorkMeasurementItem_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "ConstructionMeasurementCoverage" (
    ...
    CONSTRAINT "ConstructionMeasurementCoverage_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "ApprovalReversalRequest" (
    ...
    CONSTRAINT "ApprovalReversalRequest_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "CostCenterMembership" (
    ...
    CONSTRAINT "CostCenterMembership_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "WorkMembership" (
    ...
    CONSTRAINT "WorkMembership_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "ConstructionImport" (
    ...
    CONSTRAINT "ConstructionImport_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "ConstructionLedgerEvent" (
    ...
    CONSTRAINT "ConstructionLedgerEvent_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "ConstructionBudgetImpact" (
    ...
    "status" TEXT NOT NULL DEFAULT 'PENDING',
    "quantity" DECIMAL(65,30),
    "budgetUnitCostSnapshot" DECIMAL(65,30),
    "operationUnitCost" DECIMAL(65,30),
    "amount" DECIMAL(65,30) NOT NULL,
    "approvalRequestId" TEXT,
    "parentImpactId" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    ...
    CONSTRAINT "ConstructionBudgetImpact_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "ConstructionMonthlyFact" (
    ...
    CONSTRAINT "ConstructionMonthlyFact_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "Company" (
    ...
    "contractTemplateBlob" BYTEA,
    "contractTemplateStorageKey" TEXT,
...
CREATE TABLE "ConstructionSupplier" (
    ...
    CONSTRAINT "ConstructionSupplier_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "ConstructionWorkSupplier" (
    ...
    CONSTRAINT "ConstructionWorkSupplier_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "QuotationBudgetItem" (
    ...
    CONSTRAINT "QuotationBudgetItem_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "QuotationRound" (
    ...
    CONSTRAINT "QuotationRound_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "ProposalNegotiationEvent" (
    ...
    CONSTRAINT "ProposalNegotiationEvent_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "ContractRequestBudgetItem" (
    ...
    CONSTRAINT "ContractRequestBudgetItem_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "ContractRequestProposal" (
    ...
    "supplierName" TEXT NOT NULL,
    "originalProposalValue" DECIMAL(65,30),
    "proposalValue" DECIMAL(65,30) NOT NULL,
    "notes" TEXT,
    "suggestedWinner" BOOLEAN NOT NULL DEFAULT false,
    "rowNumber" INTEGER NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "ContractRequestProposal_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "ConstructionBaselineSchedule" (
    ...
    "plannedStart" TIMESTAMP(3),
    "plannedEnd" TIMESTAMP(3),
    "plannedWeight" DECIMAL(65,30),
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "ConstructionBaselineSchedule_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "ConstructionScheduleRevision" (
    ...
    "index" TEXT NOT NULL,
    "version" TEXT,
    "replannedStart" TIMESTAMP(3),
    "replannedEnd" TIMESTAMP(3),
    ...
    CONSTRAINT "ConstructionScheduleRevision_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "ConstructionWork" (
    ...
    "statusChangedBy" TEXT,
    "responsibleName" TEXT,
    "bdiPercentage" DECIMAL(65,30) DEFAULT 0,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "WorkCreationIdempotency" (
    ...
    CONSTRAINT "WorkCreationIdempotency_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "ConstructionMeasurementCoverage_workMeasurementItemId_contr_key" ON "ConstructionMeasurementCoverage"("workMeasurementItemId", "contractMeasurementItemId");
...
-- CreateIndex
CREATE UNIQUE INDEX "ApprovalPolicy_scopeType_scopeId_subjectType_subjectId_acti_key" ON "ApprovalPolicy"("scopeType", "scopeId", "subjectType", "subjectId", "action", "mode");
...
-- CreateIndex
CREATE INDEX "ApprovalRequest_status_requiredApproverRole_organizationId__idx" ON "ApprovalRequest"("status", "requiredApproverRole", "organizationId", "costCenterId");
...
-- CreateIndex
CREATE UNIQUE INDEX "ConstructionLedgerEvent_eventType_sourceType_sourceId_compo_key" ON "ConstructionLedgerEvent"("eventType", "sourceType", "sourceId", "componentId");

-- CreateIndex
CREATE INDEX "ConstructionBudgetImpact_ownerId_workId_budgetItemIdentityI_idx" ON "ConstructionBudgetImpact"("ownerId", "workId", "budgetItemIdentityId", "status");
...
-- CreateIndex
CREATE UNIQUE INDEX "ConstructionBudgetImpact_sourceType_sourceId_componentId_im_key" ON "ConstructionBudgetImpact"("sourceType", "sourceId", "componentId", "impactType", "budgetVersionItemId");
...
-- CreateIndex
CREATE UNIQUE INDEX "ConstructionMonthlyFact_ownerId_workId_competencia_origem_v_key" ON "ConstructionMonthlyFact"("ownerId", "workId", "competencia", "origem", "version");
...
-- CreateIndex
CREATE INDEX "ConstructionSupplier_workspaceId_idx" ON "ConstructionSupplier"("workspaceId");

-- CreateIndex
CREATE INDEX "ConstructionSupplier_workspaceId_document_idx" ON "ConstructionSupplier"("workspaceId", "document");
...
-- CreateIndex
CREATE INDEX "ConstructionWork_workspaceId_idx" ON "ConstructionWork"("workspaceId");
...
-- CreateIndex
CREATE UNIQUE INDEX "ConstructionWork_workspaceId_code_key" ON "ConstructionWork"("workspaceId", "code");
...
-- AddForeignKey
ALTER TABLE "ConstructionBudgetItem" ADD CONSTRAINT "ConstructionBudgetItem_workId_fkey" FOREIGN KEY ("workId") REFERENCES "ConstructionWork"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionBudgetItem" ADD CONSTRAINT "ConstructionBudgetItem_importId_fkey" FOREIGN KEY ("importId") REFERENCES "ConstructionImport"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionBudgetItem" ADD CONSTRAINT "ConstructionBudgetItem_identityId_fkey" FOREIGN KEY ("identityId") REFERENCES "BudgetItemIdentity"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionBudgetItem" ADD CONSTRAINT "ConstructionBudgetItem_parentId_fkey" FOREIGN KEY ("parentId") REFERENCES "ConstructionBudgetItem"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionBudgetItem" ADD CONSTRAINT "ConstructionBudgetItem_workspaceId_fkey" FOREIGN KEY ("workspaceId") REFERENCES "Workspace"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BudgetVersion" ADD CONSTRAINT "BudgetVersion_workId_fkey" FOREIGN KEY ("workId") REFERENCES "ConstructionWork"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BudgetItemIdentity" ADD CONSTRAINT "BudgetItemIdentity_workId_fkey" FOREIGN KEY ("workId") REFERENCES "ConstructionWork"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BudgetVersionItem" ADD CONSTRAINT "BudgetVersionItem_versionId_fkey" FOREIGN KEY ("versionId") REFERENCES "BudgetVersion"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BudgetVersionItem" ADD CONSTRAINT "BudgetVersionItem_identityId_fkey" FOREIGN KEY ("identityId") REFERENCES "BudgetItemIdentity"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BudgetVersionItem" ADD CONSTRAINT "BudgetVersionItem_parentVersionId_fkey" FOREIGN KEY ("parentVersionId") REFERENCES "BudgetVersionItem"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BudgetVersionItem" ADD CONSTRAINT "BudgetVersionItem_sourceVersionItemId_fkey" FOREIGN KEY ("sourceVersionItemId") REFERENCES "BudgetVersionItem"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BudgetProjectionState" ADD CONSTRAINT "BudgetProjectionState_workId_fkey" FOREIGN KEY ("workId") REFERENCES "ConstructionWork"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BudgetProjectionOutbox" ADD CONSTRAINT "BudgetProjectionOutbox_workId_fkey" FOREIGN KEY ("workId") REFERENCES "ConstructionWork"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Contract" ADD CONSTRAINT "Contract_workId_fkey" FOREIGN KEY ("workId") REFERENCES "ConstructionWork"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Contract" ADD CONSTRAINT "Contract_supplierId_fkey" FOREIGN KEY ("supplierId") REFERENCES "ConstructionSupplier"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Contract" ADD CONSTRAINT "Contract_contractRequestId_fkey" FOREIGN KEY ("contractRequestId") REFERENCES "ContractRequest"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Contract" ADD CONSTRAINT "Contract_workspaceId_fkey" FOREIGN KEY ("workspaceId") REFERENCES "Workspace"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ContractInstrumentArtifact" ADD CONSTRAINT "ContractInstrumentArtifact_contractId_fkey" FOREIGN KEY ("contractId") REFERENCES "Contract"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ContractService" ADD CONSTRAINT "ContractService_parentId_fkey" FOREIGN KEY ("parentId") REFERENCES "ContractService"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ContractService" ADD CONSTRAINT "ContractService_budgetItemId_fkey" FOREIGN KEY ("budgetItemId") REFERENCES "ConstructionBudgetItem"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ContractMeasurementItem" ADD CONSTRAINT "ContractMeasurementItem_measurementId_fkey" FOREIGN KEY ("measurementId") REFERENCES "ContractMeasurement"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ContractMeasurementItem" ADD CONSTRAINT "ContractMeasurementItem_serviceId_fkey" FOREIGN KEY ("serviceId") REFERENCES "ContractService"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ContractPayment" ADD CONSTRAINT "ContractPayment_measurementId_fkey" FOREIGN KEY ("measurementId") REFERENCES "ContractMeasurement"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ContractFolder" ADD CONSTRAINT "ContractFolder_contractId_fkey" FOREIGN KEY ("contractId") REFERENCES "Contract"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ContractFile" ADD CONSTRAINT "ContractFile_folderId_fkey" FOREIGN KEY ("folderId") REFERENCES "ContractFolder"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionContractAmendment" ADD CONSTRAINT "ConstructionContractAmendment_contractId_fkey" FOREIGN KEY ("contractId") REFERENCES "Contract"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ContractAmendmentMeasurement" ADD CONSTRAINT "ContractAmendmentMeasurement_amendmentId_fkey" FOREIGN KEY ("amendmentId") REFERENCES "ConstructionContractAmendment"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ContractAmendmentMeasurement" ADD CONSTRAINT "ContractAmendmentMeasurement_measurementId_fkey" FOREIGN KEY ("measurementId") REFERENCES "ContractMeasurement"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionMeasurement" ADD CONSTRAINT "ConstructionMeasurement_workId_fkey" FOREIGN KEY ("workId") REFERENCES "ConstructionWork"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionMeasurement" ADD CONSTRAINT "ConstructionMeasurement_importId_fkey" FOREIGN KEY ("importId") REFERENCES "ConstructionImport"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionMeasurement" ADD CONSTRAINT "ConstructionMeasurement_budgetItemId_fkey" FOREIGN KEY ("budgetItemId") REFERENCES "ConstructionBudgetItem"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionActualCost" ADD CONSTRAINT "ConstructionActualCost_workId_fkey" FOREIGN KEY ("workId") REFERENCES "ConstructionWork"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionActualCost" ADD CONSTRAINT "ConstructionActualCost_importId_fkey" FOREIGN KEY ("importId") REFERENCES "ConstructionImport"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionActualCost" ADD CONSTRAINT "ConstructionActualCost_budgetItemId_fkey" FOREIGN KEY ("budgetItemId") REFERENCES "ConstructionBudgetItem"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionActualCost" ADD CONSTRAINT "ConstructionActualCost_budgetVersionItemId_fkey" FOREIGN KEY ("budgetVersionItemId") REFERENCES "BudgetVersionItem"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionActualCost" ADD CONSTRAINT "ConstructionActualCost_supplierId_fkey" FOREIGN KEY ("supplierId") REFERENCES "ConstructionSupplier"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CostMigrationLineage" ADD CONSTRAINT "CostMigrationLineage_sourceCostId_fkey" FOREIGN KEY ("sourceCostId") REFERENCES "ConstructionActualCost"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CostMigrationLineage" ADD CONSTRAINT "CostMigrationLineage_successorCostId_fkey" FOREIGN KEY ("successorCostId") REFERENCES "ConstructionActualCost"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ActualCostAllocation" ADD CONSTRAINT "ActualCostAllocation_actualCostId_fkey" FOREIGN KEY ("actualCostId") REFERENCES "ConstructionActualCost"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ActualCostAllocation" ADD CONSTRAINT "ActualCostAllocation_budgetItemId_fkey" FOREIGN KEY ("budgetItemId") REFERENCES "ConstructionBudgetItem"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "WorkMeasurement" ADD CONSTRAINT "WorkMeasurement_workId_fkey" FOREIGN KEY ("workId") REFERENCES "ConstructionWork"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "WorkMeasurementItem" ADD CONSTRAINT "WorkMeasurementItem_measurementId_fkey" FOREIGN KEY ("measurementId") REFERENCES "WorkMeasurement"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "WorkMeasurementItem" ADD CONSTRAINT "WorkMeasurementItem_budgetItemId_fkey" FOREIGN KEY ("budgetItemId") REFERENCES "ConstructionBudgetItem"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionMeasurementCoverage" ADD CONSTRAINT "ConstructionMeasurementCoverage_workMeasurementItemId_fkey" FOREIGN KEY ("workMeasurementItemId") REFERENCES "WorkMeasurementItem"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionMeasurementCoverage" ADD CONSTRAINT "ConstructionMeasurementCoverage_contractMeasurementItemId_fkey" FOREIGN KEY ("contractMeasurementItemId") REFERENCES "ContractMeasurementItem"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ApprovalRequest" ADD CONSTRAINT "ApprovalRequest_actorId_fkey" FOREIGN KEY ("actorId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ApprovalReversalRequest" ADD CONSTRAINT "ApprovalReversalRequest_requestId_fkey" FOREIGN KEY ("requestId") REFERENCES "ApprovalRequest"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ApprovalDecision" ADD CONSTRAINT "ApprovalDecision_approverId_fkey" FOREIGN KEY ("approverId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "AuditComment" ADD CONSTRAINT "AuditComment_workId_fkey" FOREIGN KEY ("workId") REFERENCES "ConstructionWork"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AuditComment" ADD CONSTRAINT "AuditComment_authorId_fkey" FOREIGN KEY ("authorId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AuditComment" ADD CONSTRAINT "AuditComment_auditLogId_fkey" FOREIGN KEY ("auditLogId") REFERENCES "AuditLog"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "UserInvitation" ADD CONSTRAINT "UserInvitation_createdBy_fkey" FOREIGN KEY ("createdBy") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "UserInvitation" ADD CONSTRAINT "UserInvitation_workspaceId_fkey" FOREIGN KEY ("workspaceId") REFERENCES "Workspace"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "CostCenterMembership" ADD CONSTRAINT "CostCenterMembership_costCenterId_fkey" FOREIGN KEY ("costCenterId") REFERENCES "CostCenter"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CostCenterMembership" ADD CONSTRAINT "CostCenterMembership_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "WorkMembership" ADD CONSTRAINT "WorkMembership_workId_fkey" FOREIGN KEY ("workId") REFERENCES "ConstructionWork"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "WorkMembership" ADD CONSTRAINT "WorkMembership_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionImport" ADD CONSTRAINT "ConstructionImport_workId_fkey" FOREIGN KEY ("workId") REFERENCES "ConstructionWork"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionImport" ADD CONSTRAINT "ConstructionImport_workspaceId_fkey" FOREIGN KEY ("workspaceId") REFERENCES "Workspace"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ImportBatch" ADD CONSTRAINT "ImportBatch_workId_fkey" FOREIGN KEY ("workId") REFERENCES "ConstructionWork"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ImportBatch" ADD CONSTRAINT "ImportBatch_quotationId_fkey" FOREIGN KEY ("quotationId") REFERENCES "Quotation"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ImportBatch" ADD CONSTRAINT "ImportBatch_contractRequestId_fkey" FOREIGN KEY ("contractRequestId") REFERENCES "ContractRequest"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ConstructionLedgerEvent" ADD CONSTRAINT "ConstructionLedgerEvent_workId_fkey" FOREIGN KEY ("workId") REFERENCES "ConstructionWork"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionLedgerEvent" ADD CONSTRAINT "ConstructionLedgerEvent_budgetItemIdentityId_fkey" FOREIGN KEY ("budgetItemIdentityId") REFERENCES "BudgetItemIdentity"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionLedgerEvent" ADD CONSTRAINT "ConstructionLedgerEvent_budgetVersionItemId_fkey" FOREIGN KEY ("budgetVersionItemId") REFERENCES "BudgetVersionItem"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionLedgerEvent" ADD CONSTRAINT "ConstructionLedgerEvent_approvalDecisionId_fkey" FOREIGN KEY ("approvalDecisionId") REFERENCES "ApprovalDecision"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionLedgerEvent" ADD CONSTRAINT "ConstructionLedgerEvent_budgetImpactId_fkey" FOREIGN KEY ("budgetImpactId") REFERENCES "ConstructionBudgetImpact"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionBudgetImpact" ADD CONSTRAINT "ConstructionBudgetImpact_workId_fkey" FOREIGN KEY ("workId") REFERENCES "ConstructionWork"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionBudgetImpact" ADD CONSTRAINT "ConstructionBudgetImpact_budgetItemIdentityId_fkey" FOREIGN KEY ("budgetItemIdentityId") REFERENCES "BudgetItemIdentity"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionBudgetImpact" ADD CONSTRAINT "ConstructionBudgetImpact_budgetVersionItemId_fkey" FOREIGN KEY ("budgetVersionItemId") REFERENCES "BudgetVersionItem"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionBudgetImpact" ADD CONSTRAINT "ConstructionBudgetImpact_parentImpactId_fkey" FOREIGN KEY ("parentImpactId") REFERENCES "ConstructionBudgetImpact"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Company" ADD CONSTRAINT "Company_structuredAddressId_fkey" FOREIGN KEY ("structuredAddressId") REFERENCES "Address"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Organization" ADD CONSTRAINT "Organization_structuredAddressId_fkey" FOREIGN KEY ("structuredAddressId") REFERENCES "Address"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "CostCenter" ADD CONSTRAINT "CostCenter_structuredAddressId_fkey" FOREIGN KEY ("structuredAddressId") REFERENCES "Address"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CostCenter" ADD CONSTRAINT "CostCenter_workspaceId_fkey" FOREIGN KEY ("workspaceId") REFERENCES "Workspace"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionSupplier" ADD CONSTRAINT "ConstructionSupplier_workspaceId_fkey" FOREIGN KEY ("workspaceId") REFERENCES "Workspace"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionWorkSupplier" ADD CONSTRAINT "ConstructionWorkSupplier_workId_fkey" FOREIGN KEY ("workId") REFERENCES "ConstructionWork"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionWorkSupplier" ADD CONSTRAINT "ConstructionWorkSupplier_supplierId_fkey" FOREIGN KEY ("supplierId") REFERENCES "ConstructionSupplier"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "QuotationBudgetItem" ADD CONSTRAINT "QuotationBudgetItem_quotationId_fkey" FOREIGN KEY ("quotationId") REFERENCES "Quotation"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "QuotationBudgetItem" ADD CONSTRAINT "QuotationBudgetItem_budgetItemId_fkey" FOREIGN KEY ("budgetItemId") REFERENCES "ConstructionBudgetItem"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "QuotationProposal" ADD CONSTRAINT "QuotationProposal_quotationId_fkey" FOREIGN KEY ("quotationId") REFERENCES "Quotation"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "QuotationRound" ADD CONSTRAINT "QuotationRound_quotationId_fkey" FOREIGN KEY ("quotationId") REFERENCES "Quotation"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProposalNegotiationEvent" ADD CONSTRAINT "ProposalNegotiationEvent_roundId_fkey" FOREIGN KEY ("roundId") REFERENCES "QuotationRound"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProposalNegotiationEvent" ADD CONSTRAINT "ProposalNegotiationEvent_proposalId_fkey" FOREIGN KEY ("proposalId") REFERENCES "QuotationProposal"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ContractRequest" ADD CONSTRAINT "ContractRequest_workId_fkey" FOREIGN KEY ("workId") REFERENCES "ConstructionWork"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ContractRequestBudgetItem" ADD CONSTRAINT "ContractRequestBudgetItem_requestId_fkey" FOREIGN KEY ("requestId") REFERENCES "ContractRequest"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ContractRequestBudgetItem" ADD CONSTRAINT "ContractRequestBudgetItem_budgetItemId_fkey" FOREIGN KEY ("budgetItemId") REFERENCES "ConstructionBudgetItem"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ContractRequestProposal" ADD CONSTRAINT "ContractRequestProposal_batchId_fkey" FOREIGN KEY ("batchId") REFERENCES "ImportBatch"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionBaselineSchedule" ADD CONSTRAINT "ConstructionBaselineSchedule_workId_fkey" FOREIGN KEY ("workId") REFERENCES "ConstructionWork"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionBaselineSchedule" ADD CONSTRAINT "ConstructionBaselineSchedule_importId_fkey" FOREIGN KEY ("importId") REFERENCES "ConstructionImport"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionBaselineSchedule" ADD CONSTRAINT "ConstructionBaselineSchedule_budgetItemId_fkey" FOREIGN KEY ("budgetItemId") REFERENCES "ConstructionBudgetItem"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionScheduleRevision" ADD CONSTRAINT "ConstructionScheduleRevision_workId_fkey" FOREIGN KEY ("workId") REFERENCES "ConstructionWork"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionScheduleRevision" ADD CONSTRAINT "ConstructionScheduleRevision_importId_fkey" FOREIGN KEY ("importId") REFERENCES "ConstructionImport"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionScheduleRevision" ADD CONSTRAINT "ConstructionScheduleRevision_budgetItemId_fkey" FOREIGN KEY ("budgetItemId") REFERENCES "ConstructionBudgetItem"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ScheduleVersion" ADD CONSTRAINT "ScheduleVersion_workId_fkey" FOREIGN KEY ("workId") REFERENCES "ConstructionWork"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ScheduleVersionItem" ADD CONSTRAINT "ScheduleVersionItem_versionId_fkey" FOREIGN KEY ("versionId") REFERENCES "ScheduleVersion"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ScheduleVersionItem" ADD CONSTRAINT "ScheduleVersionItem_budgetItemId_fkey" FOREIGN KEY ("budgetItemId") REFERENCES "ConstructionBudgetItem"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionWork" ADD CONSTRAINT "ConstructionWork_costCenterId_fkey" FOREIGN KEY ("costCenterId") REFERENCES "CostCenter"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionWork" ADD CONSTRAINT "ConstructionWork_structuredAddressId_fkey" FOREIGN KEY ("structuredAddressId") REFERENCES "Address"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConstructionWork" ADD CONSTRAINT "ConstructionWork_workspaceId_fkey" FOREIGN KEY ("workspaceId") REFERENCES "Workspace"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "WorkCreationIdempotency" ADD CONSTRAINT "WorkCreationIdempotency_workId_fkey" FOREIGN KEY ("workId") REFERENCES "ConstructionWork"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PhotoReport" ADD CONSTRAINT "PhotoReport_workId_fkey" FOREIGN KEY ("workId") REFERENCES "ConstructionWork"("id") ON DELETE CASCADE ON UPDATE CASCADE;
