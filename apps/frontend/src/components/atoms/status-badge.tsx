...
export const AUDIT_ACTION_STATUS_MAP: StatusMap = {
	...
	CONTRACT_REQUEST_NEGOTIATED: {
		label: "Negociação de solicitação",
		tone: "info",
	},
	QUOTATION_REVERTED: { label: "Cotação revertida", tone: "warning" },
	BUDGET_IMPACT_APPROVE: {
		label: "Impacto orçamentário aprovado",
		tone: "success",
	},
	BUDGET_VERSION_ACTIVATE: {
		label: "Versão de orçamento ativada",
		tone: "success",
	},
	...
	CONTRACT_MEASUREMENT_APPROVE: {
		label: "Medição de contrato aprovada",
		tone: "success",
	},
