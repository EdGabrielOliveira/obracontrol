...
interface OrganizationBarChartProps {
...
export function OrganizationBarChart({ data }: OrganizationBarChartProps) {
		...
		<div className="rounded-xl border bg-card p-4">
			<div className="mb-4">
				...
				<p className="text-xs text-muted-foreground">
					Comparativo entre valor planejado, executado e real.
				</p>
			</div>
